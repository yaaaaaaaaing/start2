...
def update_client_expiration(client_email,type_info_list,expiration_dict_path):
...
def add_account_to_name_list(client_email,type_info_list,name_list_path):
...
if __name__ == '__main__':
    ...
    client_email = "772117987@qq.com"
    type_info_list = [{"type":"vpn account","days":0},{"type":"nf account","days":0}]

    update_client_expiration(client_email,type_info_list,expiration_dict_path)
    add_account_to_name_list(client_email,type_info_list,name_list_path)

    if updata_name_list(name_list_path,client_conf_path,hash_path,attachment_dict):
        pass
    else:
